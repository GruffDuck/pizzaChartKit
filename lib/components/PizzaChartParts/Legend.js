...
var Legend = function (_a) {
    var data = _a.data, isDarkMode = _a.isDarkMode, _b = _a.showEmptySpace, showEmptySpace = _b === void 0 ? false : _b, _c = _a.totalStorage, totalStorage = _c === void 0 ? 100 : _c, _d = _a.emptySpaceTitle, emptySpaceTitle = _d === void 0 ? 'Empty Space' : _d, // Default title for empty space
    _e = _a.unit, // Default title for empty space
    unit = _e === void 0 ? 'GB' : _e;
