...
var PizzaChart = function (_a) {
    ...
    emptySpaceTitle = _j === void 0 ? 'Empty Space' : _j, // Default empty space title
    _k = _a.unit, // Default empty space title
    unit = _k === void 0 ? 'GB' : _k;
    ...
    var _l = (0, react_1.useState)((0, ChartUtils_1.getChartDimensions)()), dimensions = _l[0], setDimensions = _l[1];
    var _m = (0, react_1.useState)('0.0'), displayValue = _m[0], setDisplayValue = _m[1];
      ...
      <react_native_1.View style={[
        ...
        <react_native_1.View style={ChartStyles_1.styles.centerTextContainer}>
          <react_native_1.Text style={[
            ...
            {"".concat(displayValue, " ").concat(unit)}
          </react_native_1.Text>
          {showEmptySpace && (<react_native_1.Text style={[
              ...
              {"/ ".concat(totalStorage, " ").concat(unit)}
            </react_native_1.Text>)}
        </react_native_1.View>
      </react_native_1.View>

      {/* Legend component - controlled by showLegend prop */}
      {showLegend && (<Legend_1.default data={data} isDarkMode={isDarkMode} showEmptySpace={showEmptySpace} totalStorage={totalStorage} emptySpaceTitle={emptySpaceTitle} unit={unit} // Pass unit prop to Legend
        />)}
    </react_native_1.View>);
};
exports.default = PizzaChart;
